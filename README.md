# [Cunoro Frontend](https://app.cunoro.finance/)

This is the front-end repo for Cunoro that allows users be part of the future of finance.

**_ Note We're currently in the process of switching to TypeScript. Please read this guide on how to use TypeScript for this repository. <https://github.com/cunoro/application/wiki/TypeScript-Refactor-General-Guidelines> _**
...
```bash
$ git clone https://github.com/cunoro/application.git
$ cd olympusdao
...
├── abi/          // Contract ABIs from snowtrace.io
...
cunoro uses [linguijs](https://github.com/lingui/js-lingui) to manage translation.

The language files are located in a submodule deployed in `src/locales/translations`. This submodule points to the [olympus translation repository](https://github.com/cunoro/cunoro-translations) -->
...
When new texts are created or existing texts are modified in the application please leave a message in the cunoroDao app-translation channel for the translators to translate them.
...
| Branch | URL |
| --- | --- |
| master | <https://app.cunoro.finance> |
| deploy | <https://staging.cunoro.finance> |
...
We keep an updated list of bugs/feature requests in [Github Issues](https://github.com/cunoro/application/issues).

![GitHub issues](https://img.shields.io/github/issues/cunoro/application?style=flat-square)

Filter by ["good first issue"](https://github.com/cunoro/application/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) to get your feet wet!
